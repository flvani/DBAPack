...
DEFINE MINEXECS=10            REM PELO MENOS 10 EXECUCOES 
DEFINE MINEXECS=3             REM PELO MENOS 3  EXECUCOES 
DEFINE MINEXECS=1             REM ESTAR PRESENTE NO CACHE

DEFINE MINEXECSBYSEC=0.00027  REM FREQUENCIA: 1 VEZ A CADA 60 MIN
DEFINE MINEXECSBYSEC=0.00055  REM FREQUENCIA: 1 VEZ A CADA 30 MIN
DEFINE MINEXECSBYSEC=0.0001   REM FREQUENCIA: 1 VEZ A CADA 10000 SEGUNDOS
DEFINE MINEXECSBYSEC=0.001    REM FREQUENCIA: 1 VEZ A CADA 1000 SEGUNDOS
DEFINE MINEXECSBYSEC=0.01     REM FREQUENCIA: 1 VEZ A CADA 100 SEGUNDOS
DEFINE MINEXECSBYSEC=1        REM FREQUENCIA: 1 VEZ A CADA SEGUNDO
DEFINE MINEXECSBYSEC=0.1      REM FREQUENCIA: 1 VEZ A CADA 10 SEGUNDOS  

DEFINE SORT="AVG_CPU_ELAPSED" REM ORDENAR PELO TEMPO MEDIO DE RESPOSTA
DEFINE SORT="CPU_ELAPSED"     REM ORDENAR PELO ACUMULADO DO TEMPO DE RESPOSTA
DEFINE SORT="AVG_CPU_TIME"    REM ORDENAR PELO TEMPO MEDIO DE USO DE CPU 
DEFINE SORT="CPU_TIME"        REM ORDENAR PELO ACUMULADO DO TEMPO DE USO DE CPU
DEFINE SORT="EXEC"            REM ORDENAR PELA QUANTIDADE DE EXECUCOES
DEFINE SORT="LIO"             REM ORDENAR PELA QUANTIDADE DE LEITURAS LOGICAS
DEFINE SORT="COPIES"          REM ORDENAR PELA QUANTIDADE DE COPIAS NO CACHE
DEFINE SORT="AVG_EXEC"        REM ORDENAR PELA MEDIA DE EXECUCOES POR SEGUNDO
DEFINE SORT="AVG_LIO"         REM ORDENAR PELA MEDIA DE LEITURAS LOGICAS POR EXECUCAO  
...
COL USER_NAME FORMAT A20 TRUNC HEAD "PARSING USER"
