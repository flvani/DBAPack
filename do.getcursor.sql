...
COL CPU_TIME FORMAT 999G999 HEAD 'CPU Time|Minutos'
COL ELAPSED_TIME FORMAT 999G999 HEAD 'Elapsed Time|Minutos'
...
SELECT /*+ ALL_ROWS NO_MERGE(V) */ 
  ...
  ,TRUNC(S.CPU_TIME/6000) CPU_TIME, TRUNC(S.ELAPSED_TIME/6000) ELAPSED_TIME
  ,S.SQL_TEXT 
  --,S.SQL_FULLTEXT
FROM V
